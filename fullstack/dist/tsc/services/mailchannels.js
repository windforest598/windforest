...
export async function sendEmail(options) {
    try {
        const fromAddr = (typeof globalThis.MAILCHANNELS_FROM !== 'undefined' ? globalThis.MAILCHANNELS_FROM : null)
 ...
 */
export function buildPMQDAlertEmail(stockName, stockCode, analysis) {
